 ...
 * 
 * import Pages.LoginPage_POM; import io.cucumber.java.en.*;
 * 
 * public class FullLoginDemoStepsPOM {
 * 
 * WebDriver driver = null; LoginPage_POM loginPagePOM;
 * 
 ...
 * loginPagePOM.enterUsername(username); loginPagePOM.enterPassword(password);
 * 
 * 
 ...
 * {
 * 
 * loginPagePOM.clickLogin(); //driver.findElement(By.id("login")).click(); }
 * 
 ...
 * 
 * 
 * loginPagePOM.checkLogoutIsDisplayed();
 * 
